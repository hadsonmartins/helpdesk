                ...
                <?php foreach ($article_data as $data) { ?>
                    <div class="col-xl-4 col-lg-4 col-md-12">
                        <div class="archives-holder mt20 mb20">
                            ...
                            <div class="archives-footer mt20"><a class="btn btn-outline-theme-secondary btn-block" href="<?= base_url() . 'articles/category/' . $data['category_slug']; ?>"><?= $this->lang->line("text_explore_all"); ?> (<?= $data['num_articles']; ?>)</a></div>
                        </div>
                    </div>
                <?php
                    $rowCount++;

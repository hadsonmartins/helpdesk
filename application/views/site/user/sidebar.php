...
<div class="profile-image-holder" id="profileImageHolder">
  <div class="profile-image">
    ...
    <?php } ?>
    <label class="label" data-toggle="tooltip" title="Trocar foto">
...
<ul class="side-menu">
  ...
  <li <?php if ($method == "index") { ?> class="active" <?php } ?>>
    <a href="<?= base_url('user'); ?>"><i class="feather icon-home"></i> <?= $this->lang->line("text_dashboard"); ?></a>
  </li>
  <li <?php if ($method == "tickets" || $method == "submit_ticket" || $method == "view_ticket") { ?> class="active" <?php } ?>>
    <a href="<?= base_url('user/tickets'); ?>"><i class="feather icon-life-buoy"></i> <?= $this->lang->line("text_tickets"); ?></a>
  </li>
  <li <?php if ($method == "profile") { ?> class="active" <?php } ?>>
    <a href="<?= base_url('user/profile'); ?>"><i class="feather icon-user"></i> <?= $this->lang->line("text_profile"); ?></a>
  </li>
  <li <?php if ($method == "change_password") { ?> class="active" <?php } ?>>
    <a href="<?= base_url('user/change-password'); ?>"><i class="feather icon-lock"></i> <?= $this->lang->line("text_change_password"); ?></a>
  </li>
  <li>
    <a href="<?= base_url('logout'); ?>"><i class="feather icon-log-out"></i> <?= $this->lang->line("text_logout"); ?></a>
  </li>
</ul>

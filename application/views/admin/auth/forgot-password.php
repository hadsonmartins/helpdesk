                    ...
                    <div class="card card-signin mt20 mb20">
                        <div class="card-body">
                            ...
                            <form id="forgotPasswordForm" method="POST" class="form-signin">
                                ...
                                <button id="forgotPasswordButton" class="btn btn-lg btn-oval btn-theme-primary btn-block text-uppercase ladda-button" data-style="zoom-in" data-size="l" type="submit"><span class="ladda-label"><?= $this->lang->line("text_send_reset_link"); ?></span></button>
                            </form>
                        </div>

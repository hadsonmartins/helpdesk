                    ...
                    <div class="card card-signin mt20 mb20">
                        <div class="card-body">
                            ...
                            <form id="resetPasswordForm" method="POST" class="form-signin">
                                ...
                                <div class="form-group">
                                    <input class="form-control" id="inputConfirmPassword" type="password" placeholder="<?= $this->lang->line("text_confirm_new_password"); ?>" name="confirm_password" maxlength="20">
                                </div>
                                <button id="loginButton" class="btn btn-lg btn-oval btn-theme-primary btn-block text-uppercase ladda-button" data-style="zoom-in" data-size="l" type="submit"><span class="ladda-label"><?= $this->lang->line("text_reset_password"); ?></span></button>
                            </form>
                        </div>
                    </div>
                    <!-- Login Card Ends-->

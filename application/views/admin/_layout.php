...
<body class="app sidebar-mini">
    ...
    <header class="app-header">
        ...
        <ul class="app-nav">
            <!-- User Menu-->
            <li class="dropdown"><a class="app-nav-item" href="#" data-toggle="dropdown" aria-label="Open Profile Menu"><i class="feather icon-user"></i></a>
    ...
    <aside class="app-sidebar">
        ...
        <ul class="app-menu">
            <li><a class="app-menu-item <?php if ($class_name == "profile" && $method_name = "dashboard") {
                                            echo "active";
                                        } ?>" href="<?= base_url('admin/'); ?>"><i class="app-menu-icon feather icon-home"></i><span class="app-menu-label"><?= $this->lang->line('text_dashboard'); ?></span></a></li>
           <!-- <?php if ($permissions['list_articles'] == TRUE || $permissions['list_article_categories'] == TRUE) { ?>
                <li class="treeview <?php if ($class_name == "articles") {
                                        echo "is-expanded";
                                    } ?>"><a class="app-menu-item <?php if ($class_name == "articles") {
                                                                        echo "active";
                                                                    } ?>" href="#" data-toggle="treeview"><i class="app-menu-icon feather icon-file-text"></i><span class="app-menu-label"><?= $this->lang->line('text_knowledge_base'); ?></span><i class="treeview-indicator lni-chevron-right"></i></a>
                    <ul class="treeview-menu">
                        <?php if ($permissions['list_articles'] == TRUE) { ?>
                            <li><a class="treeview-item <?php if ($class_name == "articles" && $method_name == "list_articles") {
                                                            echo "active";
                                                        } ?>" href="<?= base_url('admin/articles/'); ?>"><i class="feather icon-chevron-right"></i> <?= $this->lang->line('text_articles'); ?></a></li>
                        <?php } ?>
                        <?php if ($permissions['list_article_categories'] == TRUE) { ?>
                            <li><a class="treeview-item <?php if ($class_name == "articles" && $method_name == "categories") {
                                                            echo "active";
                                                        } ?>" href="<?= base_url('admin/article/categories'); ?>"><i class="feather icon-chevron-right"></i> <?= $this->lang->line('text_article_categories'); ?></a></li>
                        <?php } ?>
                    </ul>
                </li>
            <?php } ?> -->
            <?php if ($permissions['list_tickets'] == TRUE || $permissions['list_ticket_categories'] == TRUE) { ?>
                <li class="treeview <?php if ($class_name == "tickets") {
                                        echo "is-expanded";
                                    } ?>"><a class="app-menu-item <?php if ($class_name == "tickets") {
                                                                        echo "active";
                                                                    } ?>" href="#" data-toggle="treeview"><i class="app-menu-icon feather icon-life-buoy"></i><span class="app-menu-label"><?= $this->lang->line('text_tickets'); ?></span><i class="treeview-indicator lni-chevron-right"></i></a>
                    <ul class="treeview-menu">
                        <?php if ($permissions['list_tickets'] == TRUE) { ?>
                            <li><a class="treeview-item <?php if ($class_name == "tickets" && $method_name == "list_tickets") {
                                                            echo "active";
                                                        } ?>" href="<?= base_url('admin/tickets/'); ?>"><i class="feather icon-chevron-right"></i>
                                    <?= $this->lang->line('text_list_tickets'); ?></a></li>
                        <?php } ?>
                        <?php if ($permissions['list_ticket_categories'] == TRUE) { ?>
                            <li><a class="treeview-item <?php if ($class_name == "tickets" && $method_name == "categories") {
                                                            echo "active";
                                                        } ?>" href="<?= base_url('admin/ticket/categories'); ?>"><i class="feather icon-chevron-right"></i> <?= $this->lang->line('text_ticket_categories'); ?></a></li>
                        <?php } ?>
                    </ul>
                </li>
            <?php } ?>
           <!-- <?php if ($permissions['list_faqs'] == TRUE || $permissions['list_faq_categories'] == TRUE) { ?>
                <li class="treeview <?php if ($class_name == "faq") {
                                        echo "is-expanded";
                                    } ?>"><a class="app-menu-item <?php if ($class_name == "faq") {
                                                                        echo "active";
                                                                    } ?>" href="#" data-toggle="treeview"><i class="app-menu-icon feather icon-help-circle"></i><span class="app-menu-label"><?= $this->lang->line('text_faq'); ?></span><i class="treeview-indicator lni-chevron-right"></i></a>
                    <ul class="treeview-menu">
                        <?php if ($permissions['list_faqs'] == TRUE) { ?>
                            <li><a class="treeview-item <?php if ($class_name == "faq" && $method_name == "list_faqs") {
                                                            echo "active";
                                                        } ?>" href="<?= base_url('admin/faqs/'); ?>"><i class="feather icon-chevron-right"></i>
                                    <?= $this->lang->line('text_list_faq'); ?></a></li>
                        <?php } ?>
                        <?php if ($permissions['list_faq_categories'] == TRUE) { ?>
                            <li><a class="treeview-item <?php if ($class_name == "faq" && $method_name == "categories") {
                                                            echo "active";
                                                        } ?>" href="<?= base_url('admin/faq/categories'); ?>"><i class="feather icon-chevron-right"></i> <?= $this->lang->line('text_faq_categories'); ?></a></li>
                        <?php } ?>
                    </ul>
                </li>
            <?php } ?> -->
            <?php if ($permissions['list_users'] == TRUE || $permissions['user_permissions'] == TRUE) { ?>
                <li class="treeview <?php if ($class_name == "users") {
                                        echo "is-expanded";
                                    } ?>"><a class="app-menu-item <?php if ($class_name == "users") {
                                                                        echo "active";
                                                                    } ?>" href="#" data-toggle="treeview"><i class="app-menu-icon feather icon-users"></i><span class="app-menu-label"><?= $this->lang->line('text_users'); ?></span><i class="treeview-indicator lni-chevron-right"></i></a>
                    <ul class="treeview-menu">
                        <?php if ($permissions['list_users'] == TRUE) { ?>
                            <li><a class="treeview-item <?php if ($class_name == "users" && $method_name == "list_users") {
                                                            echo "active";
                                                        } ?>" href="<?= base_url('admin/users'); ?>"><i class="feather icon-chevron-right"></i>
                                    <?= $this->lang->line('text_list_users'); ?></a></li>
                        <?php } ?>
                        <?php if ($permissions['user_permissions'] == TRUE) { ?>
                            <li><a class="treeview-item <?php if ($class_name == "users" && $method_name == "permissions") {
                                                            echo "active";
                                                        } ?>" href="<?= base_url('admin/users/permissions'); ?>"><i class="feather icon-chevron-right"></i>
            ...
            <?php if ($permissions['site_settings'] == TRUE || $permissions['social_media_settings'] == TRUE || $permissions['seo_settings'] == TRUE || $permissions['role_permissions'] == TRUE || $permissions['app_settings'] == TRUE) { ?>
                <li class="treeview <?php if ($class_name == "settings") {
                                        echo "is-expanded";
                                    } ?>"><a class="app-menu-item <?php if ($class_name == "settings") {
                                                                        echo "active";
                                                                    } ?>" href="#" data-toggle="treeview"><i class="app-menu-icon feather icon-settings"></i><span class="app-menu-label"><?= $this->lang->line('text_settings'); ?></span><i class="treeview-indicator lni-chevron-right"></i></a>
                    <ul class="treeview-menu">
                        <?php if ($permissions['site_settings'] == TRUE) { ?>
                            <li><a class="treeview-item <?php if ($class_name == "settings" && $method_name == "site_settings") {
                                                            echo "active";
                                                        } ?>" href="<?= base_url('admin/settings/site'); ?>"><i class="feather icon-chevron-right"></i>
                                    <?= $this->lang->line('text_site_settings'); ?></a></li>
                        <?php } ?>
                        <?php if ($permissions['social_media_settings'] == TRUE) { ?>
                            <li><a class="treeview-item <?php if ($class_name == "settings" && $method_name == "social_media_settings") {
                                                            echo "active";
                                                        } ?>" href="<?= base_url('admin/settings/social-media'); ?>"><i class="feather icon-chevron-right"></i>
                                    <?= $this->lang->line('text_social_media_settings'); ?></a></li>
                        <?php } ?>
                        <?php if ($permissions['seo_settings'] == TRUE) { ?>
                            <li><a class="treeview-item <?php if ($class_name == "settings" && $method_name == "seo_settings") {
                                                            echo "active";
                                                        } ?>" href="<?= base_url('admin/settings/seo'); ?>"><i class="feather icon-chevron-right"></i>
                                    <?= $this->lang->line('text_seo_settings'); ?></a></li>
                        <?php } ?>
                        <?php if ($permissions['role_permissions'] == TRUE) { ?>
                            <li><a class="treeview-item <?php if ($class_name == "settings" && $method_name == "permissions") {
                                                            echo "active";
                                                        } ?>" href="<?= base_url('admin/settings/permissions'); ?>"><i class="feather icon-chevron-right"></i>
                                    <?= $this->lang->line('text_permissions'); ?></a></li>
                        <?php } ?>
                        <?php if ($permissions['app_settings'] == TRUE) { ?>
                            <li><a class="treeview-item <?php if ($class_name == "settings" && $method_name == "app_settings") {
                                                            echo "active";
                                                        } ?>" href="<?= base_url('admin/settings/app'); ?>"><i class="feather icon-chevron-right"></i>
                                    <?= $this->lang->line('text_app_settings'); ?></a></li>
                        <?php } ?>
                        <?php if ($permissions['email_settings'] == TRUE) { ?>
                            <li><a class="treeview-item <?php if ($class_name == "settings" && $method_name == "email_settings") {
                                                            echo "active";
                                                        } ?>" href="<?= base_url('admin/settings/email'); ?>"><i class="feather icon-chevron-right"></i>
                                    <?= $this->lang->line('text_email_settings'); ?></a></li>
                        <?php } ?>
                        <?php if ($permissions['email_templates'] == TRUE) { ?>
                            <li><a class="treeview-item <?php if ($class_name == "settings" && $method_name == "email_templates") {
                                                            echo "active";
                                                        } ?>" href="<?= base_url('admin/settings/email-templates'); ?>"><i class="feather icon-chevron-right"></i>

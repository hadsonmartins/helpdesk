...
<div class="row">
   <!-- <div class="col-md-6 col-lg-3">
    ...
    <div class="col-md-6 col-lg-6">
       </i><div class="widget-small secondary coloured-icon mb30"><i class="icon feather icon-life-buoy"></i>
            <div class="info">
                <h4><b><?= $this->lang->line("text_total_tickets"); ?></b></h4>
                <p><b>0<?= $number_of_tickets ?></b></p> 
            </div>
        </div>
    </div>
   ...
   <!-- <div class="col-md-6 col-lg-3">
    ...
    <div class="col-md-6 col-lg-6">
        <div class="widget-small secondary coloured-icon mb30"><i class="icon feather icon-users"></i>
            <div class="info">
                <h4><b><?= $this->lang->line("text_total_users"); ?></b></h4>
                <p><b>0<?= $number_of_users; ?></b></p>
            </div>
        </div>
    </div>
</div>
<div class="row">
   <!-- <div class="col-lg-6 col-md-6 col-sm-12">
    ...
    <div class="col-lg-12 col-md-6 col-sm-12">
        <div class="tile mb30">
            <div class="tile-title">
                <center><h3 style="color:white;"><b><?= $this->lang->line("text_recent_tickets"); ?></b></h3></center>
            </div>
            <div class="tile-content">
                        ...
                        <div class="tickets-list no-action"     id="actionCard<?= $ticket['id']; ?>">
                            ...
                            <div class="ticket-info">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h6><b>#<?= $ticket['id']; ?></b> - <?= $ticket['ticket_title']; ?></h6>
